...
&НаКлиенте
Процедура УниверсальнаяРегистрацияОбъектов(Команда)
	ОткрытьФорму("Обработка.РегистрацияИзмененийДляОбмена.Форма");
КонецПроцедуры
...
Процедура ПодготовитьСписокОбъектов()
	...
	ОбъектыКОбмену.Добавить("Документ.ВозвратТоваровОтКлиента", "Возврат товаров от клиента",  Истина, БиблиотекаКартинок.Документ);
	ОбъектыКОбмену.Добавить("Документ.ВозвратТоваровПоставщику", "Возврат товаров поставщику", Истина, БиблиотекаКартинок.Документ);
