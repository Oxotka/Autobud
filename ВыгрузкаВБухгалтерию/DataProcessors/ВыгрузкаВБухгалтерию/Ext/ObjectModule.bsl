...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ТаблицаКоманд,
		...
		"ВыгрузкаВБухгалтерию",		// Уникальный идентификатор команды
		"ОткрытиеФормы"
	);
...
Функция ПолучитьПараметрыРегистрации(ОбъектыНазначенияФормы = Неопределено, НаименованиеОбработки = "", Информация = "", Версия = "1.0")
	...
	ПараметрыРегистрации.Вставить("Наименование",    "Выгрузка в бухгалтерию");
	ПараметрыРегистрации.Вставить("Информация",      "Простая выгрузка в бухгалтерию. Выгружаем документы и зависимые справочники.");
