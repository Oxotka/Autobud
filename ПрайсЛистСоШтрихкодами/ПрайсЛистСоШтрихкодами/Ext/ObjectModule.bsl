	...
	Пока истина Цикл
		...
		Если ЭлементРезультата.ЗначенияПараметров.Количество() > 0 Тогда
			...
			Если ЗначениеЗаполнено(ЗначениеВыводимыхДанных) Тогда
				...
				ПараметрыШтрихкода.Вставить("Ширина",          Окр(40 / КоличествоМиллиметровВПикселе));
				...
				АвтоВысотаСтроки = Ложь;
				ВысотаСтроки = 60;
			Иначе
				АвтоВысотаСтроки = Истина;
				ВысотаСтроки = 0;
				КартинкаШтрихкода = Новый Картинка;
			КонецЕсли;
			...
			ДокументРезультат.Рисунки[Индекс].Картинка = КартинкаШтрихкода;
			...
			Если ОбластьДляКартинки <> Неопределено Тогда
				ОбластьДляКартинки.АвтоВысотаСтроки = АвтоВысотаСтроки;
				ОбластьДляКартинки.ВысотаСтроки = ВысотаСтроки;
