...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'Заказ поставщику v2'");
	НоваяКоманда.Идентификатор = "ЗаказПоставщику";
...
Процедура Печать(МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаказПоставщику") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"ЗаказПоставщику",
			НСтр("ru = 'Заказ поставщику v2'"),
			ПечатьЗаказаПоставщику(МассивОбъектов, ОбъектыПечати)
			);
	КонецЕсли;
...
&НаСервере
Функция ПечатьЗаказаПоставщику(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для Каждого Объект Из МассивОбъектов Цикл
		...
		ДанныеДляПечати = Документы.ЗаказПоставщику.ПолучитьДанныеДляПечатнойФормыЗаказаНаТоварыУслуги(
			Объект,
			ПараметрыПечати);
