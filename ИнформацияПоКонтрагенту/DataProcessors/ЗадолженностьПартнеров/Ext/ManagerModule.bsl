...
Процедура УстановитьЗадолженностьКлиента(Форма, Объект) Экспорт
	...
	ЗадолженностьКлиента = ЗадолженностьКлиента(Объект.Партнер, Объект.Организация, Объект.Дата);
...
Процедура УстановитьЗадолженностьПоставщика(Форма, Объект) Экспорт
	...
	ЗадолженностьПоставщика = ЗадолженностьПоставщика(Объект.Партнер, Объект.Организация, Объект.Дата);
